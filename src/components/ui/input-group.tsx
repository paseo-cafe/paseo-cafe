...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: This compound input needs ARIA grouping without fieldset form semantics.
    <div
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements lint/a11y/useKeyWithClickEvents: This wrapper groups input adornments and only expands the input's existing focus target.
    <div
      role="group"
