...
// Unstyled popup — DialogContent below bakes in the centered-card shape for
// a title/description dialog. A dialog with a different shape (e.g. a
// fullscreen lightbox) renders this directly instead of fighting
// DialogContent's positioning and width classes.
